    ...
    <AppLayout title="Board Governance">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-6">
          ...
          {canViewPortal && (
          <Link href="/legal/board/access-log" className="group">
            <Card variant="default" padding="md" className="h-full hover:border-primary-300 hover:shadow-card-hover transition-all">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-primary-50 text-primary-600 flex items-center justify-center shrink-0"><KeyRound className="w-5 h-5" /></div>
                <div className="min-w-0 flex-1">
                  <p className="font-semibold text-text-primary group-hover:text-primary-600">Director Portal &amp; Secure Links</p>
                  <p className="text-xs text-neutral-500">Passwordless portal, tokenised links &amp; access audit trail</p>
                </div>
                <ChevronRight className="w-4 h-4 text-neutral-300 group-hover:text-primary-500 shrink-0" />
              </div>
            </Card>
